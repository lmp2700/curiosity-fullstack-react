...
class Comment extends Component {
    ...
    getComments = async (e) => {
        const comments = await fetch('${process.env.REACT_APP_BACKEND_ADDRESS}/comments')
    ...
    addComment = async (newComment, e) => {
        ...
        try {
            const createdComment = await fetch('${process.env.REACT_APP_BACKEND_ADDRESS}/comments', {
                method: 'POST',
    ...
    editComment = async (comment) => {
        const editComment = await fetch('${process.env.REACT_APP_BACKEND_ADDRESS}/comments/' + comment._id, {
            method: 'PUT',
            body: JSON.stringify({
    ...
    deleteComment = async (id) => {
        const deleteComment = await fetch('${process.env.REACT_APP_BACKEND_ADDRESS}/comments/' + id, {
            method: 'DELETE'
        })
